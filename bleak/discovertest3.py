...
async def run(address, debug=False):
    ...
    # async with device as client:
        ...
        for service in client.services:
            ...
            # for x in range(14, 16): # made it to 01 00 00
            for x in range(14, 16): # made it to 01 00 00
                # for y in range(222, 255):
                for y in range(223, 255):
                    for z in range(255):
                        # zVal = (z + 67) % 255
                        zVal = z
                        data = f'1E 01 {hex(x)[2:].rjust(2, "0")} {hex(y)[2:].rjust(2, "0")} {hex(zVal)[2:].rjust(2, "0")}'
                        print(data)
                        ...
                        # client.write_gatt_char(rw_charac, data, response=True)            
